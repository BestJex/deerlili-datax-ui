  ...
  <div>
    <el-form label-position="right" label-width="150px" :model="writerForm" :rules="rules">
      ...
      <el-form-item label="前置sql语句：">
        <el-input v-model="writerForm.preSql" placeholder="perSql前置sql在insert之前执行" type="textarea" style="width: 42%" />
      </el-form-item>
      <el-form-item label="后置sql语句：">
        <el-input v-model="writerForm.postSql" placeholder="postSql后置sql在insert之后执行，多个用;分隔" type="textarea" style="width: 42%" />
      </el-form-item>
    </el-form>
  </div>
</template>
